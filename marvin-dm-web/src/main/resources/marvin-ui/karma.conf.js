...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/github/githubModule.js',
			'app/modules/github/githubCtrl.js',
			'app/modules/github/githubRoute.js',
			'app/modules/github/githubService.js',
			'app/modules/github/github-test.js',
		],
